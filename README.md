<p align="center">
    ...
    <h3> As the world races forward, leaving us behind, why not journey back to the 90s? 😃 Relive the joy of TIC TAC TOE, Pacman, and many more. These games take us to a simpler time, reminding us to slow down. Can nostalgia transport us to a magical era?🤩 </h3>
	<br>
    <h3> It is indeed possible!!  with Games-and-Go </h3>
    <h2>Checkout our Work at  <a href="https://games.ieeessitvit.tech/">SSIT LIVE </a></h2>
    <br>
    <br>     <h4 align="center">INFO</h4>
</p>
...
<!-- 	<h2 align="center">Hacktoberfest, in its 8th year, is a month-long celebration of open source software run by DigitalOcean. During the month of October, we invite you to join open-source software enthusiasts, beginners, and the developer community by contributing to open-source projects. You can do this in a variety of ways:</h2> -->
	<h1 align="center"> WHY CONTRIBUTE WITH US?</h1>
	<ul>
...
# Hello People!!  <br/>
## Make sure you read CODE_OF_CONDUCT.md before you start
